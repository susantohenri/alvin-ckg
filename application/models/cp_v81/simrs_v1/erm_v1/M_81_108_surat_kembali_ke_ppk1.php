...
class M_81_108_surat_kembali_ke_ppk1 extends CI_Model {
  ...
  public function print_notes($params)
  {
    ...
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_81_108_surat_kembali_ke_ppk1', 'aps');
    ...
    $data['form']['pdf_file_name'] = '107_consent_anastesi_'.$params['id_reg'].'_'.date('ymd');
