...
class M_81_84_surat_pernyataan_bebas_alergi_obat extends CI_Model {
  ...
  public function print_notes($params)
  {
    ...
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_81_84_surat_pernyataan_bebas_alergi_obat', 'aps');
    ...
    $cetakan = $this->aps->get_log_erm_cetakan(['id_reg' => $params['id_reg'], 'kode_form' => $params['id_ref_global_tipe_42']]);
    ...
    $data['cetakan'] = $this->aps->get_log_erm_cetakan(['id_reg' => $params['id_reg'], 'kode_form' => $params['id_ref_global_tipe_42']]);
    ...
    $data['form']['pdf_file_name'] = '84_surat_pernyataan_bebas_obat_'.$params['id_reg'].'_'.date('ymd');
