        ...
        <table border="0" cellpadding="2" width="80%" class="table center">
            ...
            <tbody>
                ...
                <tr class="grey">
                    ...
                    <td colspan="4"><?= isset($notes_169['nama_pemberi_pernyataan']) ? nl2br($notes_169['nama_pemberi_pernyataan']) : ''; ?></td>
                </tr>
                <tr>
                    <td>Umur</td>
                    <td align="center">:</td>
                    <td colspan="4"><?= isset($notes_169['umur_pemberi_pernyataan']) ? nl2br($notes_169['umur_pemberi_pernyataan']) : ''; ?></td>
                </tr>
                <tr class="grey">
                    <td>Alamat</td>
                    <td align="center">:</td>
                    <td colspan="4"><?= isset($notes_169['alamat_pemberi_pernyataan']) ? nl2br($notes_169['alamat_pemberi_pernyataan']) : ''; ?></td>
                </tr>
                <tr>
                    <td>Pekerjaan</td>
                    <td align="center">:</td>
                    <td colspan="4"><?= isset($notes_169['pekerjaan_pemberi_pernyataan']) ? nl2br($notes_169['pekerjaan_pemberi_pernyataan']) : ''; ?></td>
                </tr>
                <tr>
                    <td colspan="6">&nbsp;</td>  
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="3" align="center">
                        <img src="<?= isset($notes_169['ttd_pasien']) ? str_replace('[removed]', 'data:image/png;base64,', $notes_169['ttd_pasien']) : ''; ?>" width="100px">                    
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="center">
                ...
                <tr>
                    ...
                    <td colspan="3" align="center">
                        <?= 
                        $ttd_saksi = '';
                            if($notes_169['status_pemberi_pernyataan'] == "Pasien"){
                                $ttd_saksi = isset($notes_169['ttd_pasien']) ? str_replace('[removed]', 'data:image/png;base64,', $notes_169['ttd_pasien']) : '';
                            } else {
                                $ttd_saksi = isset($notes_169['ttd_saksi']) ? str_replace('[removed]', 'data:image/png;base64,', $notes_169['ttd_saksi']) : '';
                            }
                        ?>
                    ...
                    <?= 
                        $nama_pemberi_pernyataan = '';
                            if($notes_169['status_pemberi_pernyataan'] == "Pasien"){
                                ...
                                $nama_pemberi_pernyataan = isset($notes_169['nama_pemberi_pernyataan']) ? nl2br($notes_169['nama_pemberi_pernyataan']) : '';
                            }
                        ?>
