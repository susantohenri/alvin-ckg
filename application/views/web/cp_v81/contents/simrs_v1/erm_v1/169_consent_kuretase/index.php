        ...
        <div class="row mt-3 justify-content-center" id="table_container">
          <div class="col-12">
            ...
            <div class="row mt-4">
              ...
              <div class="col-lg-6 col-sm-12">
                <div class="fv-row mb-5" style="<?= !empty($notes_169) && $notes_169['status_pemberi_pernyataan'] == 'Pasien' ? 'display: none;' : ''; ?>">
                  <label for="notes_169_pekerjaan_pemberi_pernyataan" class="form-label">Pekerjaan Pemberi Pernyataan</label>
                  <textarea class="form-control" id="notes_169_pekerjaan_pemberi_pernyataan" name="notes_169_pekerjaan_pemberi_pernyataan"><?= isset($notes_169['pekerjaan_pemberi_pernyataan']) ? ($notes_169['pekerjaan_pemberi_pernyataan']) : ''; ?></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="row mt-4">
              ...
              <div class="col-lg-6 col-sm-12">
                <div class="fv-row">
                  <label for="notes_169_pekerjaan_pasien" class="form-label">Pekerjaan Pasien</label>
                  <input type="text" class="form-control bg-secondary" id="notes_169_pekerjaan_pasien" name="notes_169_pekerjaan_pasien" value="<?= isset($reg['pekerjaan']) ? $reg['pekerjaan'] : ''; ?>" readonly>
                </div>
              </div>
            </div>
            ...
            <div class="row mt-4">
              ...
              <div class="col-12">
                <div class="fv-row" style="<?= !empty($notes_169) && $notes_169['status_pemberi_pernyataan'] == 'Pasien' ? 'display: none;' : ''; ?>">
                  <label for="notes_169_ttd_saksi" class="form-label text-primary">TTD Saksi</label>
                  <div class="col-md-12" id="signature_pad">
                    <canvas class="border border-gray-500" id="notes_169_ttd_saksi">
                  </div>
                  <div style="width: 100%" id="signature_pad">
                    <button class="btn btn-sm btn-secondary" id="clear_notes_169_ttd_saksi">Clear</button>
                    <button class="btn btn-sm btn-secondary" id="undo_notes_169_ttd_saksi">Undo</button>
                  </div>
                  <input type="hidden" name="notes_169_ttd_saksi" value="<?= isset($notes_169['ttd_saksi']) ? $notes_169['ttd_saksi'] : ''; ?>">
                </div>
              </div>
            </div>
          </div>
