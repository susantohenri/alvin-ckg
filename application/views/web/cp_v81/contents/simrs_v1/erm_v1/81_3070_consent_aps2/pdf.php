        ...
        <table border="0" cellpadding="2" width="80%" class="table center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">:</td>
                    <td colspan="4"><?= isset($notes_3070['umur_pemberi_pernyataan']) ? nl2br($notes_3070['umur_pemberi_pernyataan']) : ''; ?></td>
                </tr>
                ...
                <tr>
                    <td colspan="6">Selaku <b><?= isset($notes_3070['telpon_pemberi_pernyataan']) ? ($notes_3070['status_pemberi_pernyataan']=="Pasien"? " Sendiri</b>": $notes_3070['status_pemberi_pernyataan'] . "</b> dari pasien ") : ''; ?> :</td>
                </tr>
                <tr class="grey">
                    <td>Nama</td>
                    <td align="center">:</td>
