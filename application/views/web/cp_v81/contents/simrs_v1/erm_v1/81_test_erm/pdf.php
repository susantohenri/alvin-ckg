...
<body>
  <?php 
    if (!empty($notes)) {
      $notes = $notes[0];
      $notes_test = $notes['json_data']['notes'];
    }
  ?>
    <div>
        ...
        <table border="0" cellpadding="2" width="80%" class="table center">
            <tbody>
                ...
                <tr class="grey">
                    ...
                    <td colspan="4"><?= isset($notes_test['nama_pemberi_pernyataan']) ? nl2br($notes_test['nama_pemberi_pernyataan']) : ''; ?></td>
                </tr>
                <tr>
                    <td>Jenis Kelamin</td>
                    <td align="center">:</td>
                    <td colspan="4"><?= isset($notes_test['jenis_kelamin_pemberi_pernyataan']) ? ($notes_test['jenis_kelamin_pemberi_pernyataan'] == 'p' ? 'Perempuan' :'Laki-laki') : ''; ?></td>
                </tr>
                <tr>
                    <td>Tgl Lahir</td>
                    <td align="center">:</td>
                    <td colspan="4"><?= isset($notes_test['tgl_lahir_pemberi_pernyataan']) ? nl2br($notes_test['tgl_lahir_pemberi_pernyataan']) : ''; ?></td>
                </tr>
                ...
                <tr>
                    <td colspan="6">Selaku <b><?= isset($notes_test['status_pemberi_pernyataan']) ? ($notes_test['status_pemberi_pernyataan']=="Pasien"? " Sendiri</b>": $notes_test['status_pemberi_pernyataan'] . "</b> dari pasien ") : ''; ?> :</td>
                </tr>
                <tr class="grey">
                    <td>Nama</td>
                    <td align="center">:</td>
                ...
                <tr>
                    <td colspan="6">
                       <b> <i><?= isset($notes_test['prognosa']) ? nl2br($notes_test['prognosa']) : ''; ?></i></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                ...
                <tr>
                    <td colspan="6">
                        4. Atas keputusan saya ini, rumah sakit telah memberikan penjelasan mengenai alternatif pengobatan selanjutnya yaitu <b><i><?= isset($notes_test['instruksi_pulang']) ? nl2br($notes_test['instruksi_pulang']) : ''; ?></i></b>.
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                ...
                <tr>
                    ...
                    <td colspan="3" align="center">
                        <img src="<?= isset($notes_test['ttd_pasien']) ? str_replace('[removed]', 'data:image/png;base64,', $notes_test['ttd_pasien']) : ''; ?>" width="100px">                    
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="center">
                    ...
                    <td colspan="3" align="center">
                        <span>(<?= isset($notes_test['nama_pemberi_pernyataan']) ? nl2br($notes_test['nama_pemberi_pernyataan']) : ''; ?>)</span>
                    </td>
                </tr>
                <tr>
