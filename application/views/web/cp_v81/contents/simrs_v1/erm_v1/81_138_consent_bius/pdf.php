...
<body>
  <?php 
    if (!empty($notes)) {
      $notes = $notes[0];
      $notes_138 = $notes['json_data']['notes'];
    }
  ?>
    <div>
        ...
        <table border="0" cellpadding="2" width="80%" class="table center text-justify">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="6" align="center"><?= isset($notes_138['nama_pemberi_pernyataan']) ? nl2br($notes_138['nama_pemberi_pernyataan']) : ''; ?></td>
                </tr>
                <tr>
                    <td colspan="6">&nbsp;</td>  
                </tr>
                <tr>
                    <td colspan="6">Menyetujui untuk dilakukan pembiusan:</td>
                </tr>
                <tr>
                    <td colspan="6" align="center"><?= isset($notes_138['pembiusan']) ? ($notes_138['pembiusan'] == "umum" ? 'Umum' : 'Lokal' ): ''; ?></td>
                </tr>
                <tr>
                ...
                <tr style="vertical-align: middle;">
                    ...
                    <td colspan="2" class="text-left">
                        : <img style="vertical-align: middle;" src="<?= isset($notes_138['ttd_pasien']) ? str_replace('[removed]', 'data:image/png;base64,', $notes_138['ttd_pasien']) : ''; ?>" width="100px">                    
                    </td>
                    <td colspan="1" class="text-left">Tanda tangan</td>
                    <td colspan="2" class="text-left">
                        : <img style="vertical-align: middle;" src="<?= isset($notes_138['ttd_saksi']) ? str_replace('[removed]', 'data:image/png;base64,', $notes_138['ttd_saksi']) : ''; ?>" width="100px">                    
                    </td>
                </tr>
                <tr style="vertical-align: middle;">
                    <td colspan="1" class="text-left">Nama Lengkap</td>
                    <td colspan="2" class="text-left">
                       : <span><?= isset($notes_138['nama_pemberi_pernyataan']) ? nl2br($notes_138['nama_pemberi_pernyataan']) : ''; ?></span>
                    </td>
                    <td colspan="1" class="text-left">Nama Lengkap</td>
                    <td colspan="2" class="text-left">
                       : <span><?= isset($notes_138['nama_saksi']) ? nl2br($notes_138['nama_saksi']) : ''; ?></span>
                    </td>
                </tr>
                <tr style="vertical-align: middle;">
                    <td colspan="1" class="text-left">Telepon</td>
                    <td colspan="2" class="text-left">
                        : <span><?= isset($notes_138['telpon_pemberi_pernyataan']) ? $notes_138['telpon_pemberi_pernyataan'] : ''; ?></span>
                    </td>
