...
class C_81_138_consent_bius extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    $this->_app_js = $this->_assets . 'web/cp_v81/simrs_v1/erm_v1/81_138_consent_bius/';
  }
  ...
  public function form_process($params = null)
  {
    ...
    if ($post['notes_138_status_pemberi_pernyataan'] != 'Pasien') {
      $this->form_validation->set_rules(
      ...
      $post['notes_138_nama_pemberi_pernyataan'] = $reg['nama_pasien'];
      $post['notes_138_telpon_pemberi_pernyataan'] = $reg['mobile_phone'];
      $post['notes_138_umur_pemberi_pernyataan'] = $reg['umur'];
      $post['notes_138_alamat_pemberi_pernyataan'] = $reg['alamat'];
    }
  ...
  public function pdf($params)
  {
    ...
    $pdf_base64 = $this->bius->print_notes(['id_reg' => $token_data['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
