...
class C_81_777_tb_info_consent_tindakan extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    $this->_id_ref_global_tipe_42 = 777;
    ...
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_81_777_tb_info_consent_tindakan', 'kuretase');
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_notes', 'notes');
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_resume_medis', 'resume');

    $this->_view = 'web/cp_v81/contents/simrs_v1/erm_v1/81_777_tb_info_consent_tindakan/';
    $this->_master = 'web/cp_v81/layout/';
    $this->_app_js = $this->_assets . 'web/cp_v81/simrs_v1/erm_v1/81_777_tb_info_consent_tindakan/';
  }
  ...
  public function form_process($params = null)
  {
    ...
    $this->form_validation->set_rules(
      ...
      'nama_saksi',
      'required',
      array('required' => 'Mohon pilih status nama saksi')
    );
    
    if ($post['notes_777_status_pemberi_pernyataan'] != 'Pasien') {
      $this->form_validation->set_rules(
      ...
      $post['notes_777_nama_pemberi_pernyataan'] = $reg['nama_pasien'];
      $post['notes_777_telpon_pemberi_pernyataan'] = $reg['mobile_phone'];
      $post['notes_777_umur_pemberi_pernyataan'] = $reg['umur'];
      $post['notes_777_alamat_pemberi_pernyataan'] = $reg['alamat'];
    }
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $output = [
        ...
        if (isset($notes['paraf_diagnosis2']) && $notes['paraf_diagnosis2'] === 'on') {
            $notes['paraf_diagnosis'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_dasar_diagnosis2']) && $notes['paraf_dasar_diagnosis2'] === 'on') {
            $notes['paraf_dasar_diagnosis'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_tindakan_kedokteran2']) && $notes['paraf_tindakan_kedokteran2'] === 'on') {
            $notes['paraf_tindakan_kedokteran'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_indikasi_tindakan2']) && $notes['paraf_indikasi_tindakan2'] === 'on') {
            $notes['paraf_indikasi_tindakan'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_tatacara2']) && $notes['paraf_tatacara2'] === 'on') {
            $notes['paraf_tatacara'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_tujuan2']) && $notes['paraf_tujuan2'] === 'on') {
            $notes['paraf_tujuan'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_resiko2']) && $notes['paraf_resiko2'] === 'on') {
            $notes['paraf_resiko'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_komplikasi2']) && $notes['paraf_komplikasi2'] === 'on') {
            $notes['paraf_komplikasi'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_resiko_prognosis2']) && $notes['paraf_resiko_prognosis2'] === 'on') {
            $notes['paraf_resiko_prognosis'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_alternatif2']) && $notes['paraf_alternatif2'] === 'on') {
            $notes['paraf_alternatif'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
        if (isset($notes['paraf_lain_lain2']) && $notes['paraf_lain_lain2'] === 'on') {
            $notes['paraf_lain_lain'] = 'on';
            unset($notes['paraf_diagnosis2']);
        }
  ...
  public function pdf($params)
  {
    ...
    $pdf_base64 = $this->kuretase->print_notes(['id_reg' => $token_data['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
...
/* End of file C_81_777_tb_info_consent_tindakan.php */
