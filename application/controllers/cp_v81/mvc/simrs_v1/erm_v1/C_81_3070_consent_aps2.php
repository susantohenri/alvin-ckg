...
class C_81_104_consent_bayar_jaminan extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_81_104_consent_bayar_jaminan', 'aps');
  ...
  {
    if (empty($params)) {
      redirect(base_url('81_list_pasien_reg'));
    }
  ...
  public function form_process($params = null)
  {
    ...
    if ($post['notes_3070_status_pemberi_pernyataan'] != 'Pasien') {
      ...
      $this->form_validation->set_rules(
        'notes_3070_umur_pemberi_pernyataan',
      ...
      $this->form_validation->set_rules(
        'notes_3070_alamat_pemberi_pernyataan',
      ...
      $post['notes_3070_umur_pemberi_pernyataan'] = $reg['umur'];
      $post['notes_3070_alamat_pemberi_pernyataan'] = $reg['alamat'];
    }
