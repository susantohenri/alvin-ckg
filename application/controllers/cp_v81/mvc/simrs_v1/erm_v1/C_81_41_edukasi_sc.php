...
class C_81_41_edukasi_sc extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    $this->_app_js = $this->_assets . 'web/cp_v81/simrs_v1/erm_v1/81_41_edukasi_sc/';
  }
  ...
  public function form_process($params = null)
  {
    ...
    $this->form_validation->set_rules(
      ...
      'pernyataan',
      'required',
      array('required' => 'Mohon pilih pemberi pernyataan')
    );
    $this->form_validation->set_rules(
      'notes_41_pernyataan',
      'pernyataan',
    ...
    if ($post['notes_41_status_pemberi_pernyataan'] != 'Pasien') {
      $this->form_validation->set_rules(
      ...
      $post['notes_41_nama_pemberi_pernyataan'] = $reg['nama_pasien'];
      $post['notes_41_telpon_pemberi_pernyataan'] = $reg['mobile_phone'];
      $post['notes_41_umur_pemberi_pernyataan'] = $reg['umur'];
      $post['notes_41_alamat_pemberi_pernyataan'] = $reg['alamat'];
    }
  ...
  public function pdf($params)
  {
    ...
    $pdf_base64 = $this->esc->print_notes(['id_reg' => $token_data['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
