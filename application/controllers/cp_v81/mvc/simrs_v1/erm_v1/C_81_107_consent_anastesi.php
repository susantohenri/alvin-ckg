...
class C_81_107_consent_anastesi extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    $this->_app_js = $this->_assets . 'web/cp_v81/simrs_v1/erm_v1/81_107_consent_anastesi/';
  }
  ...
  public function form_process($params = null)
  {
    ...
    if ($post['notes_107_status_pemberi_pernyataan'] != 'Pasien') {
      if ($post['notes_107_jenis_hipnotik_pasien'] == 'spiral_epidural' || $post['notes_107_jenis_hipnotik_pasien'] == 'never_block') {
        $this->form_validation->set_rules(
          'notes_107_jenis_hipnotik_pasien',
          'jenis_hipnotik_pasien',
          'required',
          array('required' => 'Mohon isi jenis_hipnotik')
        );
      }
      $this->form_validation->set_rules(
      ...
      $this->form_validation->set_rules(
        ...
        'required',
        array('required' => 'Mohon isi teknik pembiusan')
      );
      $this->form_validation->set_rules(
        'notes_107_teknik_pembiusan_pasien',
        'teknik_pembiusan_pasien',
      ...
      $post['notes_107_nama_pemberi_pernyataan'] = $reg['nama_pasien'];
      $post['notes_107_telpon_pemberi_pernyataan'] = $reg['mobile_phone'];
      $post['notes_107_umur_pemberi_pernyataan'] = $reg['umur'];
      $post['notes_107_alamat_pemberi_pernyataan'] = $reg['alamat'];
    }
    ...
    $this->form_validation->set_rules(
      ...
      'required',
      array('required' => 'Mohon isi tanda tangan pemberi pernyataan')
    );
    ...
    $this->form_validation->set_rules(
      ...
      'ttd_saksi',
      'required',
      array('required' => 'Mohon isi tanda tangan saksi 1')
    );
  ...
  public function pdf($params)
  {
    ...
    $pdf_base64 = $this->ca->print_notes(['id_reg' => $token_data['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
