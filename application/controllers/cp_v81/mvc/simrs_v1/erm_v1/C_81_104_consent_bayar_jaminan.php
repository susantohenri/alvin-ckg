...
class C_81_104_consent_bayar_jaminan extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    $this->_app_js = $this->_assets . 'web/cp_v81/simrs_v1/erm_v1/81_104_consent_bayar_jaminan/';
  }
  ...
  public function form_process($params = null)
  {
    ...
    if ($post['notes_104_status_pemberi_pernyataan'] != 'Pasien') {
      $this->form_validation->set_rules(
      ...
      $post['notes_104_nama_pemberi_pernyataan'] = $reg['nama_pasien'];
      $post['notes_104_telpon_pemberi_pernyataan'] = $reg['mobile_phone'];
      $post['notes_104_umur_pemberi_pernyataan'] = $reg['umur'];
      $post['notes_104_alamat_pemberi_pernyataan'] = $reg['alamat'];
    }
    ...
    $this->form_validation->set_rules(
      ...
      'no_bpjs_pasien',
      'required',
      array('required' => 'Mohon isi no bpjs')
    );
    ...
    $this->form_validation->set_rules(
      ...
      'kelas_bpjs_pasien',
      'required',
      array('required' => 'Mohon isi kelas bpjs')
    );
  ...
  public function pdf($params)
  {
    ...
    $pdf_base64 = $this->cbj->print_notes(['id_reg' => $token_data['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
