...
class C_81_169_consent_kuretase extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    $this->_app_js = $this->_assets . 'web/cp_v81/simrs_v1/erm_v1/81_169_consent_kuretase/';
  }
  ...
  public function form_process($params = null)
  {
    ...
    $this->form_validation->set_rules(
      ...
      'lain_lain',
      'required',
      array('required' => 'Mohon isi lain_lain')
    );

    if ($post['notes_169_status_pemberi_pernyataan'] != 'Pasien') {
      $this->form_validation->set_rules(
      ...
      $post['notes_169_nama_pemberi_pernyataan'] = $reg['nama_pasien'];
      $post['notes_169_telpon_pemberi_pernyataan'] = $reg['mobile_phone'];
      $post['notes_169_umur_pemberi_pernyataan'] = $reg['umur'];
      $post['notes_169_alamat_pemberi_pernyataan'] = $reg['alamat'];
    }
