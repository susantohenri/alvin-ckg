...
class C_81_134_consent_op extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    $this->_app_js = $this->_assets . 'web/cp_v81/simrs_v1/erm_v1/81_134_consent_op/';
  }
  ...
  public function form_process($params = null)
  {
    ...
    if ($post['notes_134_status_pemberi_pernyataan'] != 'Pasien') {
      $this->form_validation->set_rules(
      ...
      $post['notes_134_nama_pemberi_pernyataan'] = $reg['nama_pasien'];
      $post['notes_134_telpon_pemberi_pernyataan'] = $reg['mobile_phone'];
      $post['notes_134_umur_pemberi_pernyataan'] = $reg['umur'];
      $post['notes_134_alamat_pemberi_pernyataan'] = $reg['alamat'];
    }
  ...
  public function pdf($params)
  {
    ...
    $pdf_base64 = $this->op->print_notes(['id_reg' => $token_data['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
