...
class C_81_777_tb_info_consent_tindakan extends RestController {

  function __construct()
  {
    parent::__construct();
    $this->_class = '81_777_tb_info_consent_tindakan';
  ...
  public function index_get()
  {
    ...
    $output = [
      ...
      'data'    => [
        ...
        'status_pemberi_pernyataan' => $notes_777['status_pemberi_pernyataan'],
        'nama_pemberi_pernyataan' => $notes_777['nama_pemberi_pernyataan'],
        'telpon_pemberi_pernyataan' => $notes_777['telpon_pemberi_pernyataan'],
        'umur_pemberi_pernyataan' => $notes_777['umur_pemberi_pernyataan'],
        'alamat_pemberi_pernyataan' => $notes_777['alamat_pemberi_pernyataan'],
        'nama_saksi' => $notes_777['nama_saksi'],
        'tanggal_lahir_pasien' => $reg[0]['tanggal_lahir'],
        'jenis_kelamin_pasien' => $reg[0]['kelamin'],
        'paraf_diagnosis' => $notes_777['paraf_diagnosis'],
        'paraf_dasar_diagnosis' => $notes_777['paraf_dasar_diagnosis'],
        'paraf_tindakan_kedokteran' => $notes_777['paraf_tindakan_kedokteran'],
        'paraf_indikasi_tindakan' => $notes_777['paraf_indikasi_tindakan'],
        'paraf_tatacara' => $notes_777['paraf_tatacara'],
        'paraf_tujuan' => $notes_777['paraf_tujuan'],
        'paraf_resiko' => $notes_777['paraf_resiko'],
        'paraf_komplikasi' => $notes_777['paraf_komplikasi'],
        'paraf_resiko_prognosis' => $notes_777['paraf_resiko_prognosis'],
        'paraf_alternatif' => $notes_777['paraf_alternatif'],
        'paraf_lain_lain' => $notes_777['paraf_lain_lain'],
        'ttd_pasien' => $notes_777['ttd_pasien'],
        'ttd_saksi' => $notes_777['ttd_saksi'],
      ]
    ];
    $this->response($output, $output['status']);
  }
  ...
  public function index_post()
  {
    ...
    $this->form_validation->set_rules(
      ...
      [
        'required' => 'Mohon isi tanda tangan pasien',
        'valid_base64'  => 'Tanda tangan saksi harus dengan format base64'
      ]
    );
    ...
    $params_notes_details = [
        ...
        'paraf_komplikasi' => $post['paraf_komplikasi'],
        'paraf_resiko_prognosis' => $post['paraf_resiko_prognosis'],
  ...
  public function validation_ttd_saksi($params)
  {
    ...
    if ($ext != 'png') {
      $this->form_validation->set_message('validation_ttd_saksi', 'Tanda tangan pasien harus berformat PNG');
      return false;
    }

    $size = (strlen($params) * 3 / 4) - substr_count(substr($params, -2), '=');
    if ($size > 1000000) {
      $this->form_validation->set_message('validation_ttd_saksi', 'Ukuran tanda tangan  pasien tidak boleh lebih dari 1MB');
      return false;
    }
