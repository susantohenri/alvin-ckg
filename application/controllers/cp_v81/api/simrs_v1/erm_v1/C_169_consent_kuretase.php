...
class C_84_surat_pernyataan_bebas_alergi_obat extends RestController {

  function __construct()
  {
    parent::__construct();
    $this->_class = '84_surat_pernyataan_bebas_alergi_obat';
    ...
    $this->_view = 'web/cp_v81/contents/simrs_v1/erm_v1/84_surat_pernyataan_bebas_alergi_obat/';
  }
  ...
  public function index_get()
  {
    ...
    $output = [
      ...
      'data'    => [
        'status_pemberi_pernyataan' => $notes_84['status_pemberi_pernyataan'],
        'nama_pemberi_pernyataan' => $notes_84['nama_pemberi_pernyataan'],
        'telpon_pemberi_pernyataan' => $notes_84['telpon_pemberi_pernyataan'],
        'umur_pemberi_pernyataan' => $notes_84['umur_pemberi_pernyataan'],
        'alamat_pemberi_pernyataan' => $notes_84['alamat_pemberi_pernyataan'],
        'pekerjaan_pemberi_pernyataan' => $notes_84['pekerjaan_pemberi_pernyataan'],
        'nama_pasien' => $reg[0]['nama_pasien'],
        'umur_pasien' => $reg[0]['umur'],
        'ttd_pasien' => $notes_84['ttd_pasien'],
        'ttd_saksi' => $notes_84['ttd_saksi'],
      ]
    ];
    $this->response($output, $output['status']);
  }
  ...
  public function index_post()
  {
    ...
    if ($post['status_pemberi_pernyataan'] != 'Pasien') {
      ...
      $this->form_validation->set_rules(
        ...
        'pekerjaan_pemberi_pernyataan',
        'required',
        array('required' => 'Mohon isi pekerjaan pemberi pernyataan')
      );
    } else {
      ...
      $post['pekerjaan_pemberi_pernyataan'] = $reg['pekerjaan'];
    }
    ...
    $this->form_validation->set_rules(
      ...
      [
        'required' => 'Mohon isi tanda tangan saksi',
    ...
    $params_notes_details = [
      ...
      'pekerjaan_pemberi_pernyataan' => $post['pekerjaan_pemberi_pernyataan'],
      'nama_pasien' => $reg[0]['nama_pasien'],
      'umur_pasien' => $reg[0]['umur'],
  ...
  public function pdf_get()
  {
    ...
    $pdf_base64 = $this->notes->print_notes(['id_reg' => $get['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
  ...
  public function validation_ttd_saksi($params)
  {
    ...
    if ($ext != 'png') {
      $this->form_validation->set_message('validation_ttd_saksi', 'Tanda tangan saksi harus berformat PNG');
      return false;
    }
  
    $size = (strlen($params) * 3 / 4) - substr_count(substr($params, -2), '=');
    if ($size > 1000000) {
      $this->form_validation->set_message('validation_ttd_saksi', 'Ukuran tanda tangan saksi tidak boleh lebih dari 1MB');
      return false;
    }
...
/* End of file C_84_surat_pernyataan_bebas_alergi_obat.php */
