...
class C_81_118_consent_status_jasaraharja extends RestController {

  function __construct()
  {
    parent::__construct();
    $this->_class = '81_118_consent_status_jasaraharja';
  ...
  public function index_get()
  {
    ...
    $output = [
      ...
      'data'    => [
        'status_pemberi_pernyataan' => $notes_118['status_pemberi_pernyataan'],
        'nama_pemberi_pernyataan' => $notes_118['nama_pemberi_pernyataan'],
        'alamat_pemberi_pernyataan' => $notes_118['alamat_pemberi_pernyataan'],
        'telpon_pemberi_pernyataan' => $notes_118['telpon_pemberi_pernyataan'],
        'no_ktp_pemberi_pernyataan' => $notes_118['no_ktp_pemberi_pernyataan'],
        'nama_pasien' => $reg[0]['nama_pasien'],
        'alamat_pasien' => $reg[0]['alamat'],
        'no_ktp_pasien' => $reg[0]['no_ktp'],
        'ruang_rawat_utama' => $reg[0]['ruang_rawat'],
        'ttd_pasien' => $notes_118['ttd_pasien'],
      ]
    ];
    $this->response($output, $output['status']);
  }
  ...
  public function index_post()
  {
    ...
    if ($post['status_pemberi_pernyataan'] != 'Pasien') {
      ...
      $post['no_ktp_pemberi_pernyataan'] = $reg['no_ktp'];
    }
    ...
    $params_notes_details = [
      ...
      'no_ktp_pemberi_pernyataan' => $post['no_ktp_pemberi_pernyataan'],
  ...
  public function pdf_get()
  {
    ...
    $pdf_base64 = $this->csj->print_notes(['id_reg' => $get['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
