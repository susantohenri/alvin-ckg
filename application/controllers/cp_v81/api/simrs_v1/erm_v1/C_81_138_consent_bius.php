...
class C_81_138_consent_bius extends RestController {

  function __construct()
  {
    parent::__construct();
    $this->_class = '81_138_consent_bius';
    $this->_id_ref_global_tipe_42 = 138;
    ...
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_81_138_consent_bius', 'bius');
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_resume_medis', 'resume');
    $this->db_ref = $this->load->database('db_ref', true);
    $this->_view = 'web/cp_v81/contents/simrs_v1/erm_v1/81_138_consent_bius/';
  }
  ...
  public function index_get()
  {
    ...
    $output = [
      ...
      'data'    => [
        'status_pemberi_pernyataan' => $notes_138['status_pemberi_pernyataan'],
        'nama_pemberi_pernyataan' => $notes_138['nama_pemberi_pernyataan'],
        'alamat_pemberi_pernyataan' => $notes_138['alamat_pemberi_pernyataan'],
        'telpon_pemberi_pernyataan' => $notes_138['telpon_pemberi_pernyataan'],
        'umur_pemberi_pernyataan' => $notes_138['umur_pemberi_pernyataan'],
        'nama_pasien' => $reg[0]['nama_pasien'],
        'umur_pasien' => $reg[0]['umur'],
        'no_rm_pasien' => $reg[0]['no_rm'],
        'pembiusan' => $notes_138['pembiusan'],
        'ttd_pasien' => $notes_138['ttd_pasien'],
      ]
    ];
    $this->response($output, $output['status']);
  }
  ...
  public function index_post()
  {
    ...
    $this->form_validation->set_rules(
        ...
        'pembiusan',
        'required',
        array('required' => 'Mohon isi pembiusan')
      );
  ...
  public function pdf_get()
  {
    ...
    $pdf_base64 = $this->bius->print_notes(['id_reg' => $get['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
...
/* End of file C_81_138_consent_bius.php */
