...
class C_81_104_consent_bayar_jaminan extends RestController {

  function __construct()
  {
    parent::__construct();
    $this->_class = '81_104_consent_bayar_jaminan';
    $this->_id_ref_global_tipe_42 = 104;
    ...
    $this->load->model('cp_v81/simrs_v1/erm_v1/M_81_104_consent_bayar_jaminan', 'cbj');
    $this->db_ref = $this->load->database('db_ref', true);
    $this->_view = 'web/cp_v81/contents/simrs_v1/erm_v1/81_104_consent_bayar_jaminan/';
  }
  ...
  public function index_get()
  {
    ...
    $output = [
      ...
      'data'    => [
        'status_pemberi_pernyataan' => $notes_104['status_pemberi_pernyataan'],
        'nama_pemberi_pernyataan' => $notes_104['nama_pemberi_pernyataan'],
        'telpon_pemberi_pernyataan' => $notes_104['telpon_pemberi_pernyataan'],
        'umur_pemberi_pernyataan' => $notes_104['umur_pemberi_pernyataan'],
        'alamat_pemberi_pernyataan' => $notes_104['alamat_pemberi_pernyataan'],
        'nama_pasien' => $reg[0]['nama_pasien'],
        'umur_pasien' => $reg[0]['umur'],
        'no_bpjs_pasien' => $reg[0]['no_bpjs'],
        'kelas_bpjs_pasien' => $notes_104['kelas_bpjs_pasien'],
        'ttd_pasien' => $notes_104['ttd_pasien'],
      ]
    ];
    $this->response($output, $output['status']);
  }
  ...
  public function index_post()
  {
    ...
    $this->form_validation->set_rules(
      ...
      'no_bpjs_pasien',
      'required',
      array('required' => 'Mohon isi no bpjs pasien')
    );
    ...
    $this->form_validation->set_rules(
      ...
      'kelas_bpjs_pasien',
      'required',
      array('required' => 'Mohon isi kelas bpjs pasien')
    );
    ...
    $params_notes_details = [
      ...
      'no_bpjs_pasien' => $reg[0]['no_bpjs'],
      'kelas_bpjs_pasien' => $post['kelas_bpjs_pasien'],
      'nama_pasien' => $reg[0]['nama_pasien'],
      'umur_pasien' => $reg[0]['umur'],
  ...
  public function pdf_get()
  {
    ...
    $pdf_base64 = $this->cbj->print_notes(['id_reg' => $get['id_reg'], 'id_ref_global_tipe_42' => $this->_id_ref_global_tipe_42]);
...
/* End of file C_81_104_consent_bayar_jaminan.php */
