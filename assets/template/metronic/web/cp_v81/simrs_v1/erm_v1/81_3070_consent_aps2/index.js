  ...
  let handlePemberiPertanyaan = () => {
    $('input[name=notes_3070_status_pemberi_pernyataan]').change(function (e) {
      ...
      if ($(this).val() == 'Pasien') {
        ...
        $('[name=notes_3070_umur_pemberi_pernyataan]').val('')
        $('[name=notes_3070_alamat_pemberi_pernyataan]').val('')
        ...
        $('[name=notes_3070_nama_pemberi_pernyataan]')
          .closest('.fv-row')
          .hide('fast')
        $('[name=notes_3070_umur_pemberi_pernyataan]')
          .closest('.fv-row')
          .hide('fast')
        $('[name=notes_3070_alamat_pemberi_pernyataan]')
          .closest('.fv-row')
          .hide('fast')
        ...
        validator_3070.addField('notes_3070_umur_pemberi_pernyataan', {
          validators: {
            notEmpty: {
        ...
        validator_3070.addField('notes_3070_alamat_pemberi_pernyataan', {
          validators: {
            notEmpty: {
